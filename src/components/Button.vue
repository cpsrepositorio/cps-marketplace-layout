...
const props = defineProps({
  appearance: {
    type: String,
    validate: (value) => ['standard', 'ghost', 'accent'].includes(value),
    default: 'standard'
  }
})
